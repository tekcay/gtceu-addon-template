...
import gregicality.multiblocks.common.TKCYSAConfigHolder;
...
public abstract class GCYMRecipeMapMultiblockController extends MultiMapMultiblockController
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        ...
        if (TKCYSAConfigHolder.globalMultiblocks.enableTieredCasings && isTiered())
        ...
        MultiblockDisplayText.builder(textList, isStructureFormed())
                ...
                .addCustom(tl -> {
                    ...
                    if (isStructureFormed()) {
                        ...
                        if (TKCYSAConfigHolder.globalMultiblocks.enableTieredCasings && !list.isEmpty()) {
    ...
    public boolean isTiered() {
        return TKCYSAConfigHolder.globalMultiblocks.enableTieredCasings;
    }
    ...
    public static @NotNull TraceabilityPredicate tieredCasing() {
        return new TraceabilityPredicate(abilities(GCYMMultiblockAbility.TIERED_HATCH)
                .setMinGlobalLimited(TKCYSAConfigHolder.globalMultiblocks.enableTieredCasings ? 1 : 0)
